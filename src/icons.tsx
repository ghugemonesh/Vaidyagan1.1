...
export const Menu = (p: IconProps) => (<svg {...base(p)}><path d="M4 7h16M4 12h16M4 17h10" /></svg>);
export const Close = (p: IconProps) => (<svg {...base(p)}><path d="m6 6 12 12M18 6 6 18" /></svg>);
export const ArrowRight = (p: IconProps) => (<svg {...base(p)}><path d="M4 12h15M13.5 5.5 20 12l-6.5 6.5" /></svg>);
export const ArrowLeft = (p: IconProps) => (<svg {...base(p)}><path d="M20 12H5M10.5 5.5 4 12l6.5 6.5" /></svg>);
export const ChevronDown = (p: IconProps) => (<svg {...base(p)}><path d="m5 9 7 7 7-7" /></svg>);
export const ChevronLeft = (p: IconProps) => (<svg {...base(p)}><path d="m15 5-7 7 7 7" /></svg>);
export const ChevronRight = (p: IconProps) => (<svg {...base(p)}><path d="m9 5 7 7-7 7" /></svg>);
export const Play = (p: IconProps) => (<svg {...base(p)} fill="currentColor" stroke="none"><path d="M8 5.5v13l11-6.5-11-6.5Z" /></svg>);
export const Pause = (p: IconProps) => (
  <svg {...base(p)} fill="currentColor" stroke="none">
    <rect x="6.5" y="5" width="3.4" height="14" rx="1" /><rect x="14" y="5" width="3.4" height="14" rx="1" />
  </svg>
);
export const Check = (p: IconProps) => (<svg {...base(p)}><path d="m4.5 12.5 5 5 10-11" /></svg>);
...
export const XSocial = (p: IconProps) => (<svg {...base(p)}><path d="m4.5 4.5 15 15M19.5 4.5l-15 15" /></svg>);
...
export const Clock = (p: IconProps) => (<svg {...base(p)}><circle cx="12" cy="12" r="8.5" /><path d="M12 7v5l3.2 2" /></svg>);
export const Star = (p: IconProps) => (
  <svg {...base(p)} fill="currentColor" stroke="none">
    <path d="m12 3 2.7 5.6 6.1.8-4.5 4.2 1.1 6-5.4-3-5.4 3 1.1-6L3.2 9.4l6.1-.8L12 3Z" />
  </svg>
);
export const Monitor = (p: IconProps) => (<svg {...base(p)}><rect x="3" y="4.5" width="18" height="12.5" rx="2" /><path d="M9 20.5h6M12 17v3.5" /></svg>);
export const Phone = (p: IconProps) => (<svg {...base(p)}><rect x="7" y="2.5" width="10" height="19" rx="2.5" /><path d="M10.5 18.5h3" /></svg>);
export const Send = (p: IconProps) => (<svg {...base(p)}><path d="M20.5 3.5 3.5 10l7 2.5 2.5 7 7.5-16Z" /><path d="m10.5 12.5 4.5-4.5" /></svg>);
...
export const Key = (p: IconProps) => (<svg {...base(p)}><circle cx="8" cy="12" r="4" /><path d="M12 12h8.5M18 12v3M15.5 12v2.2" /></svg>);
...
export const Person = (p: IconProps) => (<svg {...base(p)}><circle cx="12" cy="8" r="4" /><path d="M4.5 20c.8-4 3.7-6 7.5-6s6.7 2 7.5 6" /></svg>);
...
export const Expand = (p: IconProps) => (<svg {...base(p)}><path d="M9 4H4v5M15 4h5v5M9 20H4v-5M15 20h5v-5" /></svg>);
export const Compress = (p: IconProps) => (<svg {...base(p)}><path d="M4 9h5V4M20 9h-5V4M4 15h5v5M20 15h-5v5" /></svg>);
...
export const RefreshIcon = (p: IconProps) => (<svg {...base(p)}><path d="M20 12a8 8 0 1 1-2.3-5.6M20 3.5V8h-4.5" /></svg>);
...
export const Activity = (p: IconProps) => (<svg {...base(p)}><path d="M3 12h4l2.5-6.5L14 18l2.5-6H21" /></svg>);
export const Diamond = (p: IconProps) => (<svg {...base(p)} fill="currentColor" stroke="none"><path d="M12 5l6 7-6 7-6-7 6-7Z" /></svg>);
...
export const AlignLeft = (p: IconProps) => (<svg {...base(p)}><path d="M4 6h16M4 10h10M4 14h16M4 18h10" /></svg>);
export const AlignCenter = (p: IconProps) => (<svg {...base(p)}><path d="M4 6h16M7 10h10M4 14h16M7 18h10" /></svg>);
export const AlignJustify = (p: IconProps) => (<svg {...base(p)}><path d="M4 6h16M4 10h16M4 14h16M4 18h16" /></svg>);
